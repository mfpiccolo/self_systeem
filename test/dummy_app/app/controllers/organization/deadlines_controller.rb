class Organization::DeadlinesController < User::BaseController
  ...
  def create
    ...
    if @deadline.save
      ...
      redirect_to [@organization, @project, @deadline],
        notice: "Deadline successfully added."
    else
      render "shared/deadlines/form"
    end
  end
  ...
  def destroy
    set_deadline
    @deadline.destroy
    redirect_to [@organization, @project, :deadlines],
  ...
  def select
    ...
    render "shared/deadlines/select"
  end
